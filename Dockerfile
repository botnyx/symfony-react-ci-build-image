...
RUN wget https://raw.githubusercontent.com/fabianonline/telegram.sh/master/telegram -O /bin/telegram
RUN chmod +x /bin/telegram
COPY /bin/telegram /usr/bin/telegram
